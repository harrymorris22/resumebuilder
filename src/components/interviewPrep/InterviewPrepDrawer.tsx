...
export function InterviewPrepDrawer({ open, onClose }: InterviewPrepDrawerProps) {
  if (!open) return null;
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed inset-y-0 left-0 w-full max-w-2xl bg-white border-r border-stone-200 z-50 flex flex-col shadow-lg">
        {/* Header */}
